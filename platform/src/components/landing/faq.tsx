...
const items = [
  ...
  },
  {
    ...
    a: 'Elke analyse doorloopt een vaste procescontrole. Financiële cijfers worden steekproefsgewijs geverifieerd tegen primaire bronnen zoals jaarverslagen en kwartaalcijfers.',
  },
  {
